...
def generate_response(result, intent):
    ...
    if result.get("type") == "summary":
        ...
        prompt = (
            ...
            "- Treat driver names and group names as single immutable entities. Even if they contain commas, 'and', or multiple words, do not split them, rephrase them, or treat them as multiple entities.\n"
            "- Do not add quotes around vehicle names, group names, or driver names in the final response.\n"

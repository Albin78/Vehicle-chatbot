...
def generate_response(result, intent):
    ...
    if result.get("type") == "summary":
        prompt = (
            ...
            "- Do not add any introductory header, extra commentary, or conversational filler outside of the requested structure.\n"
        ...
        prompt = (
            ...
            "* **Safety & Security**: Ignition is off, seatbelt is equipped but not fastened, and remote immobilization is supported (not currently immobilized)\n"
            "\n"

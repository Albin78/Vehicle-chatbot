...
def generate_response(result, intent):
    ...
    prompt = (
        "You are a professional fleet management chatbot. Your task: rewrite the INPUT below as OUTPUT.\n"
        "\n"
        "CONTRACT:\n"
        ...
        "- For descriptive fields (camera, seatbelt, ignition, door, immobilization),"
        " preserve the exact descriptive phrase from INPUT.\n"
        ...
        "OUTPUT: Vehicle 1832RXB is currently at 0 km/h with a fuel capacity of 400 L."
        " Last updated May 22, 2026, 10:36 AM UTC.\n"
        "</example>\n"
        "\n"
        "<example>\n"
